...
class Blockchain(object):
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            print(f'{block}')
            print("\n----------\n")
            # Проверяе, что хэш этого блока корректен
    ...
    def proof_of_work(self, last_proof):
        ...
        - p это предыдущий proof, a p' это новый proof
    ...
    def valid_proof(last_proof, proof):
        ...
        :параметр last_proof: <int> предыдущий proof_of_work
        :параметр proof: <int> Текущий proof_of_work
        :return: <bool> True если всё верно, иначе False.
        """
...
def mine():
    ...
    # Если sender = "0", то это означает что данный узел заработал биткоин.
